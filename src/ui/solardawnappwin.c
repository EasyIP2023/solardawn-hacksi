...
static void search_text_changed (GtkEntry *entry) {
  ...
  win = SOLARDAWN_APP_WINDOW (gtk_widget_get_toplevel (GTK_WIDGET (entry)));
...
static void find_word (GtkButton *button, SolarDawnAppWindow *win) {
  SolarDawnAppWindowPrivate *priv;
  const gchar *word;
...
static void update_words (SolarDawnAppWindow *win) {
  SolarDawnAppWindowPrivate *priv;
  GHashTable *strings;
  GHashTableIter iter;
...
static void update_lines (SolarDawnAppWindow *win) {
  SolarDawnAppWindowPrivate *priv;
  GtkWidget *tab, *view;
  GtkTextBuffer *buffer;
  GtkTextIter iter;
...
static void visible_child_changed (GObject *stack, GParamSpec *pspec) {
  ...
  win = SOLARDAWN_APP_WINDOW (gtk_widget_get_toplevel (GTK_WIDGET (stack)));
  priv = solardawn_app_window_get_instance_private (win);
...
static void words_changed (GObject *sidebar, GParamSpec *pspec, SolarDawnAppWindow *win) {
  update_words (win);
}
...
static void solardawn_app_window_init (SolarDawnAppWindow *win) {
  ...
  builder = gtk_builder_new_from_resource ("/org/gtk/solardawnapp/gears-menu.ui");
...
static void solardawn_app_window_class_init (SolarDawnAppWindowClass *class) {
  ...
  gtk_widget_class_bind_template_child_private (GTK_WIDGET_CLASS (class), SolarDawnAppWindow, search);
  gtk_widget_class_bind_template_child_private (GTK_WIDGET_CLASS (class), SolarDawnAppWindow, searchbar);
  gtk_widget_class_bind_template_child_private (GTK_WIDGET_CLASS (class), SolarDawnAppWindow, searchentry);
  gtk_widget_class_bind_template_child_private (GTK_WIDGET_CLASS (class), SolarDawnAppWindow, gears);
  gtk_widget_class_bind_template_child_private (GTK_WIDGET_CLASS (class), SolarDawnAppWindow, words);
  gtk_widget_class_bind_template_child_private (GTK_WIDGET_CLASS (class), SolarDawnAppWindow, sidebar);
  gtk_widget_class_bind_template_child_private (GTK_WIDGET_CLASS (class), SolarDawnAppWindow, lines);
  gtk_widget_class_bind_template_child_private (GTK_WIDGET_CLASS (class), SolarDawnAppWindow, lines_label);
