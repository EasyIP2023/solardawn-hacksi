...
static void solardawn_app_startup (GApplication *app) {
	...
	builder = gtk_builder_new_from_file ("ui_files/app-menu.ui");
...
SolarDawnApp *solardawn_app_new (void) {
  return g_object_new (SOLARDAWN_APP_TYPE, "application-id", "org.gtk.solardawnapp", "flags", G_APPLICATION_HANDLES_OPEN, NULL);
}
